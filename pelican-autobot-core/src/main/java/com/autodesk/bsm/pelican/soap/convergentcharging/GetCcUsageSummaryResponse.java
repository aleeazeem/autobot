...
@XmlType(name = "", propOrder = { "listOfCcUsageSummary" })
...
public class GetCcUsageSummaryResponse {
     ...
     *
     * @return possible object is {@link GetCcUsageSummaryResponse.ListOfCcUsageSummary }
     */
     ...
     *
     * @param value allowed object is {@link GetCcUsageSummaryResponse.ListOfCcUsageSummary }
     */
    public void setListOfCcUsageSummary(final GetCcUsageSummaryResponse.ListOfCcUsageSummary value) {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "ccSummaryUsage" })
    public static class ListOfCcUsageSummary {

        @XmlElement(name = "CcSummaryUsage")
        protected List<CcSummaryUsage> ccSummaryUsage;
         ...
         * method for the ccSummaryUsage property.
         * <p>
         * <p>
         ...
         */
        public List<CcSummaryUsage> getCcSummaryUsage() {
            if (ccSummaryUsage == null) {
                ccSummaryUsage = new ArrayList<>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "",
            propOrder = { "summaryType", "txnType", "txnTimeStamp", "guid", "firstName", "lastName", "email",
                    "accountCSN", "contractNumber", "offerType", "serviceCode", "serviceCategory", "productLineCode",
                    "usageType", "userLogon", "subscriptionLevel", "unitType", "unitValue" })
