 ...
 */
public class BasicOfferingBootstrapTest extends SeleniumWebdriver {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BasicOfferingBootstrapTest.class.getSimpleName());
    ...
    public void testBootStrapWithIdFilter() {
        ...
        final List<Map<String, String>> resultList = DbUtils.selectQuery(
            "select id from offering where APP_FAMILY_ID = 2001 and offering_type not in (0,3) order by id "
                + "desc limit 5;",
        ...
        final BootstrapEventStatusPage bootstrapEventStatusPage = bootstrapChangeNotificationsPage
            .publishBootStrapEntities(BootstrapEntityType.BASIC_OFFERING.getDisplayName(), PelicanConstants.ID_RANGE,
        ...
        HelperForAssertions.assertionsForBootstrap(bootstrapEventStatusPage,
            PelicanConstants.BASIC_OFFERING_CHANGE_NOTIFICATIONS_BOOTSTRAP_JOB, eventsList.size(), assertionErrorList);
        HelperForAssertions.commonAssertionsOnChangeNotifications(eventsList,
            BootstrapEntityType.BASIC_OFFERING.getDisplayName(), assertionErrorList);
    ...
    public void testBootStrapWithDateRangeFilter() {
        ...
        final BootstrapEventStatusPage bootstrapEventStatusPage = bootstrapChangeNotificationsPage
            .publishBootStrapEntities(BootstrapEntityType.BASIC_OFFERING.getDisplayName(), PelicanConstants.DATE_RANGE,
